...
-- usata per il trigger di num_righe
...
BEGIN
    INSERT INTO Studente_Svolge_Test(data_ultima_risposta, data_prima_risposta, email_studente, titolo_test, stato)
    VALUES (p_data_ultima_risposta, p_data_prima_risposta, p_email_studente, p_titolo_test, p_stato);
END//
DELIMITER ;
