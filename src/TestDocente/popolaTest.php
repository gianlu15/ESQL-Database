...
?>
    ...
    <body>
        ...
        <a href="creazioneTest.php">
            <button>Indietro</button>
        </a>
            <h1>Nome Test: <?php echo htmlspecialchars($testName); ?></h1>
            <button onclick="window.location.href='creazioneQuesito.php?test_name=<?php echo urlencode($testName); ?>&tipo=Chiuso'">Nuovo Quesito Chiuso</button>
            <button onclick="window.location.href='creazioneQuesito.php?test_name=<?php echo urlencode($testName); ?>&tipo=Codice'">Nuovo Quesito Codice</button>
                    ...
                    <div class="quesito">
                        ...
                        <div class="dati">
                            ...
                            <?php elseif ($quesito['tipo'] === 'Chiuso') : ?>
                                <a href="creazioneOpzione.php?numero_quesito=<?php echo urlencode($quesito['numero_progressivo']); ?>&titolo_test=<?php echo urlencode($testName); ?>">
                                    <button>Aggiungi Opzioni</button>
                                </a>
                            <?php endif; ?>
                            ...
                            <?php if ($quesito['tipo'] === 'Codice') : ?>
                                <a href="creazioneSoluzione.php?numero_quesito=<?php echo urlencode($quesito['numero_progressivo']); ?>&titolo_test=<?php echo urlencode($testName); ?>">
                                    <button>Aggiungi Soluzione</button>
                                </a>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div id="action-buttons">
                <button id="fatto-button" onclick="window.location.href='gestioneTest.php'">Fatto</button>
            </div>
        <?php endif; ?>
    </body>
