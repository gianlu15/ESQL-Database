...
try {
    $stmt = $pdo->prepare("CALL VISUALIZZA_MESSAGGI_INVIATI_STUDENTE(:email_studente)");
...
<header>
    ...
    <h1 id="pageTag">Messaggi Inviati</h1>
    </header>
    ...
    <?php if (count($messaggi) > 0): ?>
        <?php foreach ($messaggi as $messaggio): ?>
            <div class="messaggio">
                ...
                <p><strong>A:</strong> <?php echo htmlspecialchars($messaggio['email_docente']); ?></p>
